...
if ($master_id) {
    try {
        ...
        // 1️⃣ الحصول على الـ national_id أولاً من جدول النقابة
        ...
        if ($row) {
            ...
            // 2️⃣ الحصول على user_id المرتبط بنفس الرقم الوطني
